      ...
      <div class="grid-col-1-1-1-2 footer-contents">
          ...
          <div class="content-links">
            <div class="content-links-animation-block">
              <div v-for="(content, idx) in item.contents" :key="content.text + idx" class="content">
                ...
                <a v-else-if="content.to === undefined" :href="content.href" :aria-label="$t(content.text)" target="_blank" rel="noopener noreferrer">
        ...
        <div class="donate-us">
          ...
          <div class="links">
            ...
            <a :href="'https://etherscan.io/address/' + ethDonationAddress" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://blockchain.info/address/1DECAF2uSpFTP4L1fAHR8GCLrPqdwdLse9" target="_blank" rel="noopener noreferrer">
              <p class="crypto-link no-padding" data-btc="1DECAF2uSpFTP4L1fAHR8GCLrPqdwdLse9">

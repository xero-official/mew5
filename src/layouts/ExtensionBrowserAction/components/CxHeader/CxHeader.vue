    ...
    <b-nav class="cx-header">
      <b-nav-item to="/">
        <div class="d-flex logo-block">
          <img :src="require(`@/assets/images/short-hand-logo-mewcx.png`)" alt height="50" />
        ...
        <div class="d-flex menu-items">
          <!--<a href="https://ccswap.myetherwallet.com/#/" target="_blank">
            <div class="d-flex buy-eth">
              <img alt class="buy-eth-icon" src="@/assets/images/icons/buy-eth.svg" height="24" />
              <p>{{ $t('mewcx.buy-eth') }}</p>
            </div>
          </a>-->

<template>
<b-modal ref="xwalletModal" :title="$t('accessWallet.xwallet-title')" hide-footer class="bootstrap-modal nopadding modal-mew-connect" centered>
  <div class="modal-container">
    ...
    <div class="appstore-button-container">
      <!--<div class="links-container">
        <a v-if="canDownloadApple" href="https://itunes.apple.com/tt/app/xwallet-by-pundi-x/id1321754661" target="_blank" rel="noopener noreferrer">
          <img src="~@/assets/images/icons/appstore.svg" height="35" />
        </a>
        <div v-else @click="openIpadModal">
          <img src="~@/assets/images/icons/appstore.svg" height="35" />
        </div>
        <a href="https://play.google.com/store/apps/details?id=com.pundix.xwallet" target="_blank" rel="noopener noreferrer">

        ...
        <div class="page-container">
          <div class="flex-col-1-1-vertical-center content">
            ...
            <div class="image-content">
              <img :alt="$t('common.mew-icon')" class="mew-icon" src="~@/assets/images/home/mew-icon.png" />
            </div>
            <div class="animation-content">
              <img :alt="$t('common.spaceman')" class="spaceman" src="~@/assets/images/home/spaceman.png" />
            </div>
          </div>
        </div>
      </div>
